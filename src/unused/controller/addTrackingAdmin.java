...
/**
 * Servlet implementation class addTrackingAdmin
 */
@WebServlet("/addTrackingAdmin")
public class addTrackingAdmin extends HttpServlet {
	private static final long serialVersionUID = 1L;
	   private trackDAO dao;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public addTrackingAdmin() {
        super();
        dao = new trackDAO();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
					...
					RequestDispatcher view = request.getRequestDispatcher("addTrackingAdmin.jsp");
