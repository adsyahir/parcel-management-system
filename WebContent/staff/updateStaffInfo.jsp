...
<h1>Update Staff Information</h1><br>
<fieldset>
	<label for="role"><b>Staff ID</b></label>
	<input type="text" name="sid" value="${s.staffID}" readonly><br>
	
	<label for="name"><b>Staff Name</b></label>
	<input type="text" name="sname" value="${s.staffName}"><br>
	
	<label for="role"><b>Staff Password</b></label>
	<input type="text" name="spassword" value="${s.staffPassword}"><br>
	
	<label for="role"><b>Staff Position</b></label>
	<input type="text" name="sposition" value="${s.staffPosition}"><br>
	
	<label for="role"><b>Staff Email</b></label>
	<input type="text" name="semail" value="${s.staffEmail}"><br>
	
	<label for="role"><b>Staff Address</b></label>
	<input type="text" name="saddress" value="${s.staffAddress}"><br>
	
	<label for="role"><b>Admin ID</b></label>
	<input type="text" name="adminid" value="${s.adminID}" readonly><br>
