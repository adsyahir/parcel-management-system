...
<div class="container background">
  <h2 style="margin-bottom:50px; margin-left:200px;">Update Tracking</h2>
  <form class="form-horizontal" action="updateTrackingController"  method="post">
    <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Tracking ID</label>
      <div class="col-sm-4">
        <input type="text" class="form-control" id="email" value="${p.pid}" name="pid" readonly>
        <input type="text"  value="${s.staffID}" name="sid" hidden="hidden">
      </div>
    </div>
    <div class="form-group">;
      <label class="control-label col-sm-2" for="pwd">Tracking Event</label>
      <div class="col-sm-4">          
        <input type="text" class="form-control" id="pwd"  name="tevent" required>
      </div>
    </div>
     <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Tracking Process</label>
      <div class="col-sm-4">
        <input type="text" class="form-control" id="email" name="tprocess" required>
      </div>
    </div>
       <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Parcel Time</label>
      <div class="col-sm-2">
       <input type="time" class="form-control" id="formtime" name="ttime" readonly>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Parcel Date</label>
      <div class="col-sm-2">
       <input type="date" class="form-control" id="formdate" placeholder="Enter Date" name="tdate" readonly>
      </div>
    </div>
    <div class="form-group">        
