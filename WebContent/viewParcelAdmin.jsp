...
<!-- !PAGE CONTENT! -->
<div class="w3-main" style="margin-left:800px;margin-top:43px;">
 <div class="container background">
  <h2 style="margin-bottom:50px; margin-left:100px;">Parcel Information</h2>
  <form class="form-horizontal" action="updateTrackingController"  method="post">
    <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Parcel ID</label>
      <div class="col-sm-4">
            <label > <c:out value="${p.pid}"/></label>
      </div>
    </div>
    <div class="form-group">;
      <label class="control-label col-sm-2" for="pwd">Sender Name</label>
      <div class="col-sm-4">  
      <label > <c:out value="${p.psendname}"/></label>        
      </div>
    </div>
     <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Sender Phone Number</label>
      <div class="col-sm-4">
       <label > <c:out value="${p.psendadd}"/></label>   
      </div>
    </div>
       <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Sender Email</label>
      <div class="col-sm-4">
       <label > <c:out value="${p.psendemail}"/></label>   
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
         <label > <c:out value="${p.preceivername}"/></label>
      </div>
    </div>
      <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Receiver Address</label>
      <div class="col-sm-4">
         <label > <c:out value="${p.preceiveradd}"/></label>
      </div>
    </div>
      <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Receiver Phone Number</label>
      <div class="col-sm-4">
         <label > <c:out value="${p.preceiverphone}"/></label>
      </div>
    </div>
      <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Receiver Email</label>
      <div class="col-sm-4">
         <label > <c:out value="${p.preceiveremail}"/></label>
      </div>
    </div>
      <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Parcel Postcode</label>
      <div class="col-sm-4">
         <label > <c:out value="${p.ppostcode}"/></label>
      </div>
    </div>
     <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Parcel Weight</label>
      <div class="col-sm-4">
         <label > <c:out value="${p.pweight}"/></label>
      </div>
    </div>
     <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Parcel Date</label>
      <div class="col-sm-4">
         <label > <c:out value="${p.pdate}"/></label>
      </div>
    </div>
     <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Parcel Detail</label>
      <div class="col-sm-4">
         <label > <c:out value="${p.pdetail}"/></label>
      </div>
    </div>
      <div class="form-group">
      <label class="control-label col-sm-2" for="staff">Courier name</label>
      <div class="col-sm-4">
         <label > <c:out value="${p.pcouriername}"/></label>
      </div>
    </div>
