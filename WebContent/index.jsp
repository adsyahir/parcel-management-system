...
<body id="home">
    <header class="header">
      <h2><a href="#home">SPEED POST</a></h2>
      ...
      <div class="flex">
        ...
        <div class="row row-flex">
          <div class="box-1 revealator-zoomin">
            <h2>AbOUT US</h2>
            <p>
              Established in June 2021, this company was formed with a mission
        ...
        <div class="row margin-top space-around row-flex-1">
          <div class="single-about-us-bottom revealator-zoomin">
            ...
            <h4>WHAT WE DO</h4>
            <p>
              Speed Post is an express delivery company based on top-notch modernized e-technology with tagline
          ...
          >
            ...
            <h4>OUR HISTORY</h4>
            <p>
            Speed Post was founded in 2021 by four young talented man which are Hafiz, Hannan, Megat and Adam. Our company has expanded all over Malaysia, Vietnam, Philipines
            ,Thailand and Singapore. Future expansion remains unknown as they are still doing market research. Speed Post has seen rapid increase in business in the last years and
            has become fourth biggest parcel company in the world.
            </p>
          </div>
          <div
          ...
          >
            ...
            <h4>OUR MISSION</h4>
            <p>
              Speed Post will produce superior financial returns for its shareowners by providing high value-added logistics, transportation and related business services through focused operating companies. Customer requirements will be met in the highest quality manner appropriate to each market segment served.
          </div>
        </div>
      </div>
    </div>
