...
<a href="#" class="w3-bar-item w3-button w3-padding-16 w3-hide-large w3-dark-grey w3-hover-black" onclick="w3_close()" title="close menu"><i class="fa fa-remove fa-fw"></i>  Close Menu</a>
    <a href="insertParcel.jsp" class="w3-bar-item w3-button w3-padding"><i class="fa fa-plus fa-fw"></i>  Add Parcel Information</a>
    <a href="ListParcelController" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>  List Parcel </a>
	<a href="addCourier.jsp" class="w3-bar-item w3-button w3-padding"><i class="fa fa-plus fa-fw"></i>  Add Courier Information</a>
    <a href="#" class="w3-bar-item w3-button w3-padding w3-blue" style="cursor: not-allowed;"><i class="fa fa-eye fa-fw"></i> List Parcel Information</a>
